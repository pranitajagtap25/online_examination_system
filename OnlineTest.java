...
{  
    ...
    {  
        ...
        {  
			...
			try
			{
				Connection connection = (Connection) DriverManager.getConnection("jdbc:mysql://localhost/jdbc","root","");
            ...
            JOptionPane.showMessageDialog(this,username+" you have given "+count+" correct answers");  
            System.exit(0);  
        }  
    }  
    void set()  
